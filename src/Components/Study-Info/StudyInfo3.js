        ...
        <form onSubmit={handleStart}>
          ...
          <div className="step-row">
            ...
            <div className="step-content">
              <p>
 All candidates are fictional. In the first part of the study, you cast a true vote for 'John Doe' in an election. In this second part, please imagine that you are being coerced after casting a true vote. To protect your original choice, we ask that you <strong>cast an invalid vote</strong> for 'Sofia Lee' in the voting system.              </p>
              <label className="check-box blue-bg-highlight">
                ...
                />
I understand and will cast an invalid vote for 'Sofia Lee' to safeguard my original choice against coercion.              </label>
            </div>
          </div>
